...
import { Col, Row, Divider, Cell, CellGroup, Popup, Dialog, Image as VanImage } from 'vant'
...
app
  .use(Col).use(Row).use(Divider).use(Cell).use(CellGroup).use(Popup).use(Dialog).use(VanImage)
